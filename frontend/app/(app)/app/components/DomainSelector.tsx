  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <h1 className="mt-4 text-3xl font-bold tracking-tight text-slate-900">어떤 데이터인가요?</h1>
      ...
      <div className="relative">
        <input
          ...
          autoFocus
          className="w-full rounded-xl border border-slate-200 bg-slate-100 px-4 py-3.5 text-slate-900 placeholder-slate-600 outline-none ring-0 transition focus:border-amber-500/50 focus:bg-slate-100 text-sm"
        />
        {domain && (
          <button
            onClick={() => setDomain("")}
      ...
      <p className="mt-3 text-center text-xs text-slate-800">
        비워두면 범용으로 분석합니다
      </p>
    </div>
  );
